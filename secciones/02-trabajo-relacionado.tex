...
Los algoritmos que sustentan esta línea de investigación son identificables, y se reparten
según la tarea. En la detección de reseñas manipuladas, y no en la estimación de riesgo del
vendedor, predominan los modelos de lenguaje basados en transformadores:
...
instrumento que se ejecute del lado del comprador y emita su advertencia antes del pago. Hay
una segunda diferencia, visible en la última columna de la Tabla~\ref{tab:comparativa}: todos
ellos emiten una salida en cada caso, porque operan sobre los datos completos de quien los
ejecuta, mientras que el instrumento aquí propuesto debe decidir con lo que la ficha deja ver
y, cuando eso no alcanza, declararlo en lugar de responder. Esta
